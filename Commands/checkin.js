...
module.exports.run = async (bot, message, args,) => {
    ...
    if(command === prefix + 'checkin') {

        client.participants.create({
            id: 'kryptoniks3',
            participant: {
             name: args[0],//might not need this snippet
                                
                POST: `'https://api.challonge.com/v1/tournaments/${id}/participants/${args[0]}/check_in.json'` 
            },
            callback: (err, data) => {
